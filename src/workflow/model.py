...
def model_training(
    ...
    python_package_gcs_uri = f"{staging_bucket}/consult-app-trainer.tar.gz"

    job = aip.CustomPythonPackageTrainingJob(
        display_name="consult-app-training",
...
def model_deploy(
    ...
    display_name = "Consult App Model"
    ARTIFACT_URI = f"gs://{bucket_name}/model"

    # Upload and Deploy model to Vertex AI
    # Reference: https://cloud.google.com/python/docs/reference/aiplatform/latest/
    # google.cloud.aiplatform.Model#google_cloud_aiplatform_Model_upload
    ...
    # Reference: https://cloud.google.com/python/docs/reference/aiplatform/latest/
    # google.cloud.aiplatform.Model#google_cloud_aiplatform_Model_deploy
