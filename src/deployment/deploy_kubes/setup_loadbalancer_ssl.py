...
from pulumi import ResourceOptions  # Output, StackReference
import pulumi_kubernetes as k8s


def setup_loadbalancer_ssl(namespace, k8s_provider, api_service, frontend_service, app_name):

    # Get a global ip address
    ip_address = gcp.compute.GlobalAddress(
        "global-static-ip",
        name="consult-global-ip",
