...
# Setup Load Balancer
if setupSSL:
    ip_address, ingress, host = setup_loadbalancer_ssl(namespace, k8s_provider, api_service, frontend_service, app_name)
else:
    ip_address, ingress, host = setup_loadbalancer(namespace, k8s_provider, api_service, frontend_service, app_name)
